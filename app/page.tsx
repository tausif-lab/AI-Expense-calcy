          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Most startups waste thousands annually on unused ChatGPT,
                Claude, and Copilot seats. Credex Audit analyzes your stack,
                finds the bloat, and tells you exactly what to cut.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              The Great AI SaaS Sprawl
            </h2>
            <p className="text-lg text-gray-600">
              Teams are buying overlapping AI tools without oversight. What
              starts as a $20 subscription quickly scales into a massive blind
              spot.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600">
                Paying for ChatGPT Plus, Claude Pro, and Gemini Advanced for the
                same employees.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600">
                Enterprise plans requiring 50+ seats where only 12 engineers are
                actually utilizing Cursor or Copilot.
              </p>
            </div>
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <p className="text-gray-600">
                Failing to optimize between usage-based API billing and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl">
              Get full visibility into your AI spend in three simple steps. No
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600">
                Securely list your current AI subscriptions, seat counts, and
                monthly API spend.
              </p>
            </div>
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600">
                Our engine cross-references your stack with active pricing tiers
            ...
            <div className="relative z-10">
              ...
              <p className="text-gray-600">
                Get an actionable, shareable report with exact steps to
                downgrade, consolidate, or cancel.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-xl text-gray-400 mb-8">
                Generate crisp, highly-shareable audits that you can drop
                straight into Slack or your next finance meeting.
              </p>
            ...
            <div className="bg-[#111] border border-gray-800 rounded-2xl p-8 shadow-2xl">
              ...
              <div className="mb-8 p-6 bg-gray-800/50 rounded-xl border border-gray-700/50">
                ...
                <p className="text-sm text-gray-400">
                  By consolidating Claude and ChatGPT to a centralized API
                  wrapper, you can reduce SaaS overhead by 42%.
                </p>
              </div>
      ...
      <section className="py-24 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-10">
            Join hundreds of startups running leaner AI stacks. It takes 2
            minutes to find out how much you can save.
          </p>
